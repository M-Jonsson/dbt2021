...
def replace_values_qpcr(destinations, sources):
    ...
    # Create a copy
    file_in = f'c:\\users\\{local_user}\\onedrive\\dokument\\python\\dbt2021\\qPCR\\qpcr_blueprint.py'
    file_out = f'c:\\users\\{local_user}\\onedrive\\dokument\\python\\dbt2021\\qPCR\\qpcr_output.py'
